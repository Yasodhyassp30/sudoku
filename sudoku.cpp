...
int main(int argc, char *argv[])
{
    ...
    if (puzzleSize == SIZE_9X9) // for 9x9 puzzle
    {
        ...
        if (!readPuzzleVaildate(sudoku9x9)) // if puzzle is not valid return error
        {
            cerr << "Error: Invalid Sudoku puzzle." << endl;
            return 0;
        }
        emptySpaces = getEmptySpaces(sudoku9x9);
